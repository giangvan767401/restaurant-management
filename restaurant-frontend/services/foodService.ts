...
export const foodService = {
  list: (): Promise<ProductDTO[]> => apiFetch<ProductDTO[]>('/foods', { method: 'GET', auth: false }),
  create: (f: ProductDTO) => apiFetch<ProductDTO>('/foods', { method: 'POST', body: JSON.stringify(f), auth: false }),
