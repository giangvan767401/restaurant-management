    ...
    return (
        <div className="rounded-2xl border p-4">
            <div className="grid gap-3 sm:grid-cols-2">
                ...
                />
                <textarea
                    className="sm:col-span-2 rounded-md border p-2"
                    placeholder="Mô tả"
            ...
            <div className="mt-3 flex gap-2">
                <button onClick={handleSubmit} className="rounded-md bg-gray-900 px-3 py-1.5 text-white">
                    Lưu
                </button>
                <button onClick={onCancel} className="rounded-md border px-3 py-1.5">
                    Hủy
                </button>
            </div>
        </div>
